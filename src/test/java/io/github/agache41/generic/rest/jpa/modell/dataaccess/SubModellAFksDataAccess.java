...
public class SubModellAFksDataAccess extends AbstractLocalH2DataAccess<SubModellAFks, Long> {

    public SubModellAFksDataAccess() {
        super(SubModellAFks.class, Long.class);
    }
}
